...
- (TBToolGroupModel*)encryptTools {
    if (!_encryptTools) {
        ...
        item2.brief = @"TripleDES是DES的一个更安全的变形，相当于是对每个数据块应用三次DES加密算法。";
